...
|------|--------|------|---------|-----------| :------: |---------|-------------|
| namespace | `path` | string | `string` |  | ✓ |  | The namespace name. |
| Body | `body` | [DestinationRule](#destination-rule) | `models.DestinationRule` | | ✓ | |  |

#### All responses
| Code | Status | Description | Has headers | Schema |
|------|--------|-------------|:-----------:|--------|
| [200](#istio-destinationrule-create-200) | OK | IstioConfig details of an specific Istio Object |  | [schema](#istio-destinationrule-create-200-schema) |
| [201](#istio-destinationrule-create-201) | Created | IstioConfig details of an specific Istio Object |  | [schema](#istio-destinationrule-create-201-schema) |
| [404](#istio-destinationrule-create-404) | Not Found | A NotFoundError is the error message that is generated when server could not find what was requested. |  | [schema](#istio-destinationrule-create-404-schema) |
| [500](#istio-destinationrule-create-500) | Internal Server Error | A Internal is the error message that means something has gone wrong |  | [schema](#istio-destinationrule-create-500-schema) |

#### Responses


##### <span id="istio-destinationrule-create-200"></span> 200 - IstioConfig details of an specific Istio Object
Status: OK
...
##### <span id="istio-destinationrule-create-201"></span> 201 - IstioConfig details of an specific Istio Object
Status: Created

###### <span id="istio-destinationrule-create-201-schema"></span> Schema
   
  

[IstioConfigDetails](#istio-config-details)

##### <span id="istio-destinationrule-create-404"></span> 404 - A NotFoundError is the error message that is generated when server could not find what was requested.
Status: Not Found

###### <span id="istio-destinationrule-create-404-schema"></span> Schema
   
  

[IstioDestinationruleCreateNotFoundBody](#istio-destinationrule-create-not-found-body)

##### <span id="istio-destinationrule-create-500"></span> 500 - A Internal is the error message that means something has gone wrong
Status: Internal Server Error

###### <span id="istio-destinationrule-create-500-schema"></span> Schema
   
  

[IstioDestinationruleCreateInternalServerErrorBody](#istio-destinationrule-create-internal-server-error-body)

###### Inlined models

**<span id="istio-destinationrule-create-internal-server-error-body"></span> IstioDestinationruleCreateInternalServerErrorBody**
...
**<span id="istio-destinationrule-create-not-found-body"></span> IstioDestinationruleCreateNotFoundBody**
...
|------|--------|------|---------|-----------| :------: |---------|-------------|
| namespace | `path` | string | `string` |  | ✓ |  | The namespace name. |
| Body | `body` | [VirtualService](#virtual-service) | `models.VirtualService` | | ✓ | |  |

#### All responses
| Code | Status | Description | Has headers | Schema |
|------|--------|-------------|:-----------:|--------|
| [200](#istio-virtualservice-create-200) | OK | IstioConfig details of an specific Istio Object |  | [schema](#istio-virtualservice-create-200-schema) |
| [201](#istio-virtualservice-create-201) | Created | IstioConfig details of an specific Istio Object |  | [schema](#istio-virtualservice-create-201-schema) |
| [404](#istio-virtualservice-create-404) | Not Found | A NotFoundError is the error message that is generated when server could not find what was requested. |  | [schema](#istio-virtualservice-create-404-schema) |
| [500](#istio-virtualservice-create-500) | Internal Server Error | A Internal is the error message that means something has gone wrong |  | [schema](#istio-virtualservice-create-500-schema) |

#### Responses


##### <span id="istio-virtualservice-create-200"></span> 200 - IstioConfig details of an specific Istio Object
Status: OK
...
##### <span id="istio-virtualservice-create-201"></span> 201 - IstioConfig details of an specific Istio Object
Status: Created

###### <span id="istio-virtualservice-create-201-schema"></span> Schema
   
  

[IstioConfigDetails](#istio-config-details)

##### <span id="istio-virtualservice-create-404"></span> 404 - A NotFoundError is the error message that is generated when server could not find what was requested.
Status: Not Found

###### <span id="istio-virtualservice-create-404-schema"></span> Schema
   
  

[IstioVirtualserviceCreateNotFoundBody](#istio-virtualservice-create-not-found-body)

##### <span id="istio-virtualservice-create-500"></span> 500 - A Internal is the error message that means something has gone wrong
Status: Internal Server Error

###### <span id="istio-virtualservice-create-500-schema"></span> Schema
   
  

[IstioVirtualserviceCreateInternalServerErrorBody](#istio-virtualservice-create-internal-server-error-body)

###### Inlined models

**<span id="istio-virtualservice-create-internal-server-error-body"></span> IstioVirtualserviceCreateInternalServerErrorBody**
...
**<span id="istio-virtualservice-create-not-found-body"></span> IstioVirtualserviceCreateNotFoundBody**
